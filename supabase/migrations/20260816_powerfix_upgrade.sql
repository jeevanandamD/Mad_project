...
-- =============================================================================
-- Backward Compatibility: Preserves full structural and schema compatibility
-- with legacy SUCS tables: profiles, complaints, emergency_requests.
-- =============================================================================
...
-- 1. PROFILES TABLE (PowerFix User Entity)
...
-- 2. COMPLAINTS TABLE (PowerFix Electricity Work Orders)
...
alter table public.complaints add column if not exists category text default 'Electrical';
...
-- 3. EMERGENCY REQUESTS TABLE (PowerFix Hazard SOS)
